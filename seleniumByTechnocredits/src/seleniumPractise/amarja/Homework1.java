...
public class Homework1 {
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//input[contains(@id,'UserFirst')]")).sendKeys("Amarja");
		System.out.println("First Name entered");
		String s1 = driver.findElement(By.xpath("//input[contains(@id,'UserFirst')]")).getAttribute("value");
		driver.findElement(By.xpath("//input[contains(@id,'UserLast') and @name='ulname']")).sendKeys("Belorkar");
